    ...
    <div class="row page-title-box d-flex align-items-center justify-content-between">
        ...
        <div class="col-md-2">
            <ul class="breadcrumb m-0 float-end">
                <li>About</li>
                <li class="active"><i class='bx bx-chevron-right'></i>View</li>
            </ul>
        </div>
    </div>
    <!-- end page title -->
                        ...
                        <div class="card-header border-bottom-dashed p-4">
                            <div class="d-flex justify-content-between">
                                <div class="col-lg-4 col-md-6">
                                    <img src="{{ asset('/storage/cover/' . $invoice->image) }}" alt="" width="250px"
                                        height="190px">
                                </div>
                                <div class="col-lg-4 col-md-6">
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div id="pincode" class="pincode" style="">
                                        <h5 ><span class="text-muted text-capitalize fw-normal">Invoice PIN Code:</span>
                ...
                <div class="col-lg-12">
                    <div class="card-body border-bottom border-bottom-dashed p-4">
                        ...
                        <div class="hstack gap-2 justify-content-start d-print-none mt-4">
                            ...
                            <a href="{{ route('invoices.index') }}" class="btn btn-primary waves-effect"><i
